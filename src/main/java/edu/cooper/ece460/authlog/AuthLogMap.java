    ...
    throws IOException, InterruptedException
{
    ...
    if (parts.length > 10 && daemon.equals("systemd-logind") &&
    ...
    else if (parts.length > 8 && daemon.equals("sshd") && parts[5].equals("Accepted")) {
        // Format: Accepted password for username from 8.8.8.8 port 12345 ssh2
        String user = parts[8];
        writeOutput(user,host,"ssh");
    }
    else if (parts.length > 11 && daemon.equals("login") && parts[5].equals("FAILED")) {
